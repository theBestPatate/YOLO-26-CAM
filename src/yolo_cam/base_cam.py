...
from .activations_and_gradients import Activations_and_gradients_recorder
...
class BaseCAM:
    def __init__(
        ...
        self.activations_and_grads = Activations_and_gradients_recorder(
    ...
    def forward(
        ...
        if targets is None:
            match self.task:
                ...
                case Task.ORIENTED_BOUNDING_BOX:
    ...
    def compute_cam_per_layer(
        self, input_tensor: np.array, targets: List[Module], eigen_smooth: bool
    ) -> np.ndarray:
        activations_list = [
